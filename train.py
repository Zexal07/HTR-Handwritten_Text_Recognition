...
class CRNN(nn.Module):
    def __init__(self, img_height, vocab_size, hidden_size):
        ...
        # Step 1: Improved CNN with deeper architecture and BatchNorm
        ...
        # Step 2: Improved RNN with dropout and extra layer
        self.rnn = nn.LSTM(
    ...
    def _init_weights(self):
        """Step 3: Proper weight initialization"""
...
def train_htr_model(data_loader, model, criterion, optimizer, device, scheduler=None):
    """Step 2: Training with gradient clipping - returns lowest loss from epoch"""
    model.train()
    min_loss = float('inf')
...
if __name__ == "__main__":
    ...
    # Step 3: Image normalization + augmentation
    ...
    mini_size = 5000
    # Step 3: Fix mini-dataset logic with random sampling
    ...
    # Step 2: Add learning rate scheduler
    ...
    for epoch in range(1, Config.NUM_EPOCHS + 1):
        ...
        # Save model at every epoch with the lowest loss so far
